...
/**
 * Auth0 JWT validation middleware for Next.js API routes
 * Validates JWT tokens from Auth0 for protected routes
 * 
 * Setup Requirements:
 * 1. Set AUTH0_DOMAIN in .env.local (e.g., your-tenant.auth0.com)
 * 2. Set AUTH0_AUDIENCE in .env.local (your API identifier)
